...
> **Important:** TRS-ARM must be flashed and verified **before** integration into the airframe. USB-C and SWD access are not available once the rocket is closed out.
...
- [ ] Radio link confirmed with TRS-GND / TRS-ECU on the bench
