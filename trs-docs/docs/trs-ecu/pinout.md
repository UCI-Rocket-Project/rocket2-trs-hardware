...
Same PCB as TRS-GND and TRS-ARM (`rocket2-trs-hardware`). All STM32 pin assignments are identical. Only the Ethernet and radio interfaces are active in the ECU role — the FC switch is not used.

## STM32F103C8Tx Pin Assignments

| Pin No. | STM32 Pin | Signal | Direction | Description | Active in ECU |
|---------|-----------|--------|-----------|-------------|:---:|
...
| 18 | PB0 | — | — | General IO | — |
| 19 | PB1 | — | — | General IO | — |
| 20 | PB2 | ETH_RST | OUT | Ethernet Xport reset | ✅ |
...
| 45 | PB8 | — | — | General IO | — |
| 46 | PB9 | — | — | General IO | — |
| 21 | PB10 | STM_TX_ETH_RX | OUT | UART TX → Ethernet Xport RX | ✅ |
| 22 | PB11 | STM_RX_ETH_TX | IN | UART RX ← Ethernet Xport TX | ✅ |
...
| 14 | PA4 | — | — | General IO | — |
| 15 | PA5 | NMOS2 | OUT | FC switch NMOS gate 2 | ❌ Not used |
| 16 | PA6 | NMOS1 | OUT | FC switch NMOS gate 1 | ❌ Not used |
| 17 | PA7 | — | — | General IO | — |
...
|-----------|------|----------|
| J1 (Conn_01x02_Pin) | 2 | +8V input / barrel connector |
...
| J7 (Screw_Terminal_01x02) | 2 | External signal terminal |
