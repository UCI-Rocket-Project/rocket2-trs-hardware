...
| LoRa Module | SEEEDSTUDIOLORAERMINI (U6) | 433 MHz Secondary LoRa interface |
...
| Item | Description |
|------|-------------|
| Battery Manager | Barrel jack input, manages ECU battery charging and output |
| 5V Power Supply | External 5V supply input to the board via USB-C |
